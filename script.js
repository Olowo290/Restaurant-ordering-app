                        ...
                        function(menu){
                            ...
                            <div class="container">
                                ...
                                <div  id="btn" class="btn" data-addmenu="${menu.id}">
                                    <button class="add-btn" data-addmenu="${menu.id}">+</button>
                                </div>
...
//get the removed object and remove it from the Ordered array
  function handleRemovedItems(OrderedId){
      const orderedobjIndex = OrderedItems.findIndex(function(menu){
          return menu.id == OrderedId
      }) //to get the index of the object being removed
      OrderedItems.splice(orderedobjIndex, 1) //then remove it from from there OrderedItems array 
      console.log(orderedobjIndex)
      RenderOrderHTML()
  }
